...
public class ReflectionUtils {
	...
	public static Method findMethod(Class<?> clazz, String name, @Nullable Class<?>... paramTypes) {
		...
		Assertions.requireNonNull(name, "Method name must not be null");
	...
	public static Field findField(Class<?> clazz, @Nullable String name, @Nullable Class<?> type) {
		Assertions.requireNonNull(clazz, "Class must not be null");
		Assertions.requireTrue(name != null || type != null, "Either name or type of the field must be specified");
		Class<?> searchType = clazz;
	...
	public static void shallowCopyFieldState(final Object src, final Object dest) {
		Assertions.requireNonNull(src, "Source for field copy cannot be null");
		Assertions.requireNonNull(dest, "Destination for field copy cannot be null");
	...
	public interface MethodFilter {
		...
		default MethodFilter and(MethodFilter next) {
			Assertions.requireNonNull(next, "Next MethodFilter must not be null");
	...
	public interface FieldFilter {
		...
		default FieldFilter and(FieldFilter next) {
			Assertions.requireNonNull(next, "Next FieldFilter must not be null");
